 ...
 for (var i = 0; i < items.length; i++) {
     ...
     frontBox.style.backgroundImage = 'url(./Images/Photoes/' + (i + 1).toString().padStart(2, '0') + '.jpg)';
     leftBox.style.backgroundImage = 'url(./Images/Photoes/' + (i + 1).toString().padStart(2, '0') + '.jpg)';
     rightBox.style.backgroundImage = 'url(./Images/Photoes/' + (i + 1).toString().padStart(2, '0') + '.jpg)';
 ...
 (function () 
 {
     ...
     function move(index) {
         ...
         document.body.style.backgroundImage = 'url(./Images/Background/' + (index).toString().padStart(2, '0') + '.jpg)';
